...
impl Instruction for StructStart {
    ...
    fn accept_start_struct(
        ...
        buffers: &mut SerializationContext,
    ) -> Result<usize> {
...
impl Instruction for StructUnknownField {
    ...
    fn accept_i8(&self, _: &Structure, buffers: &mut SerializationContext, _: i8) -> Result<usize> {
    ...
    fn accept_u8(&self, _: &Structure, buffers: &mut SerializationContext, _: u8) -> Result<usize> {
        self.accept(buffers, DepthChange::None)
    }
    ...
    fn accept_null(&self, _: &Structure, buffers: &mut SerializationContext) -> Result<usize> {
        self.accept(buffers, DepthChange::None)
    }

    fn accept_default(&self, _: &Structure, buffers: &mut SerializationContext) -> Result<usize> {
        self.accept(buffers, DepthChange::None)
    }
    ...
    fn accept_end_tuple(&self, _: &Structure, buffers: &mut SerializationContext) -> Result<usize> {
        self.accept(buffers, DepthChange::Dec)
    }

    fn accept_start_map(&self, _: &Structure, buffers: &mut SerializationContext) -> Result<usize> {
        self.accept(buffers, DepthChange::Inc)
    }

    fn accept_end_map(&self, _: &Structure, buffers: &mut SerializationContext) -> Result<usize> {
        self.accept(buffers, DepthChange::Dec)
    }
...
impl StructUnknownField {
    fn accept(
        ...
        match (depth_change, buffers.buffers.u0[self.depth].len()) {
            ...
            (DepthChange::Dec, 1) => {
                buffers.buffers.u0[self.depth].pop(())?;
                Ok(self.next)
            }
            (DepthChange::Dec, _) => {
                buffers.buffers.u0[self.depth].pop(())?;
            ...
            (DepthChange::Inc, _) => {
                buffers.buffers.u0[self.depth].push(());
                Ok(self.self_pos)
            }
        }
    }
